(function ($) {
    ...
    function setGridItem() {
        ...
        for (var i = 1; i < 8; i++) {
            $('.catalog-category-view .itemgrid-adaptive .show-grid').removeClass('products-itemgrid-'+i+'col');
        }
        $('.catalog-category-view .itemgrid-adaptive .show-grid').addClass('products-itemgrid-'+newcol+'col');
        $i = 0;
        $('.show-grid > .item').each(function () {
            $i++;
