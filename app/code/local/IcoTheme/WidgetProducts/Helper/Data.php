...
class IcoTheme_WidgetProducts_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    protected function _initCollection($params = array())
    {
        ...
        if (isset($params['category_ids'])) {
            $productIds = $this->getProductIdsByCategories($params['category_ids']);
     ...
     * @return Mage_Catalog_Model_Resource_Product_Collection
     */
    protected function _initCollectionByCategory($params = array())
    {
        /* @var $collection Mage_Catalog_Model_Resource_Product_Collection */
        $collection = Mage::getResourceModel('catalog/product_collection');
        /* @var $layer Mage_Catalog_Model_Layer */
    ...
    protected function _getProductCategoryCollection($category)
    {
        ...
        $collection = $this->_initCollectionByCategory($params);
