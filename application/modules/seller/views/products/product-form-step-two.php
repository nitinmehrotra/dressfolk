                                    ...
                                    <span class='copy-this'>
                                        <div class='clearfix'>
                                            ...
                                            <div class='span3'>
                                                ...
                                                <input type='text' name='product_color[]' required="required" class="" placeholder="(eg.:- Blue)"/>
                                            </div>
                                            <div class='span3'>
                                                <label>Available quantity with you<span class="required">*</span></label>
                                                <input type='text' name='product_quantity[]' required="required" class="" placeholder="(eg.:- 100)"/>
                                            </div>
                                            <div class='span3'>
                                                <label>Min. quantity customer shall order<span class="required">*</span></label>
                                                <input type='text' name='product_min_quantity[]' required="required" class="" placeholder="(eg.:- 10)"/>
                                            </div>
                                        </div>
                                    </span>
                                </div>
