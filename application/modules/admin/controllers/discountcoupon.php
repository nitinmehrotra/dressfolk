...
//            prd($data);
    ...
    public function addCoupon()
    {
        ...
        if ($this->input->post())
        {
            $arr = $this->input->post();
            $dc_id = $arr["dc_id"];
            $arr["dc_admin_id"] = $this->session->userdata["admin_id"];
            $arr["dc_ipaddress"] = $this->session->userdata["ip_address"];
            $arr["dc_useragent"] = $this->session->userdata["user_agent"];
            $arr["dc_start_time"] = date('Y-m-d H:i:s', strtotime($arr["dc_start_time"]));
            $arr["dc_end_time"] = date('Y-m-d H:i:s', strtotime($arr["dc_end_time"]));
//                prd($arr);
