<?php
    ...
    class Earnings extends CI_Controller
    {
        ...
        public function index()
        {
            ...
            $seller_records = $model->fetchSelectedData('seller_id, seller_fullname, seller_company_name', TABLE_SELLER, NULL, 'seller_company_name, seller_fullname');
            ...
            if ($this->input->get('from') && $this->input->get('to'))
            {
                ...
                $whereCondArr['seller_id'] = $this->input->get('seller_id');
            ...
            $data["seller_records"] = $seller_records;
