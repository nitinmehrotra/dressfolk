...
<div style="display: none">
    <div id="popup_newsletter" class="block block-subscribe">
        ...
        <div class="content">
            Subcribe to the PUROSHOP mailing list to receive update on    mnew arrivals, special offers and other discount information.        </div>
        <form action="http://puro.icotheme.com/newsletter/subscriber/new/" method="post" id="popup-newsletter-validate-detail">
            <div class="block-content">
                <div class="input-box">
                    <input type="text" name="email" id="popup-newsletter" title="Sign up for our newsletter" class="input-text required-entry validate-email" />
        ...
        if (!(subscribeFlag && isSuccess) && !$.cookie('newsletterSubscribe')) {
            $.colorbox({
                ...
                onOpen: function () {
                    ...
                    $(".newsletterbox").css({
                        'background-image': 'url(http://puro.icotheme.com/<?php echo FRONT_ASSETS_PATH; ?>/wysiwyg/icotheme/newsletter/default/newsletter.jpg)',
