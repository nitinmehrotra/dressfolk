                            ...
                            <ul class="nav-accordion nav-mobile-accordion">
                                ...
                                foreach ($nested_category as $pcKey => $pcValue)
                                {
                                    ...
                                    <li class="level0 nav-7 level-top parent">
                                        <a href="<?php echo base_url('products/category/' . $pcValue['pc_url']); ?>" class="level-top">
                                        ...
                                        if (!empty($pcValue['cc_records']))
                                        {
                                            ...
                                            {
                                                echo '<li class="level2 nav-7-1-1 first"><a href="' . base_url('products/categories/' . $pcValue['pc_url'] . '/' . $ccValue['cc_url']) . '"><span>' . stripslashes($ccValue['cc_name']) . '</span></a></li>';
                                            }
                                            echo '</ul></li></ul>';
                                        }
                                        ?>
                    ...
                    <div class="row">
                        <form id="search_mini_form" action="<?php echo base_url('products/search'); ?>" method="get">
                            <div class="input-group form-search">
                                ...
                                <input type="hidden" name="cat_id" class="search_cat_id" value=""/>
