        ...
        <div id="mobile-sticky" class="main-header visible-xs">
            <div class="header-content visible-xs">
                                ...
                                <li class="level0 nav-6 level-top first parent">
                                    ...
                                    <ul class="level0">
                                        <li class="level1 item nav-6-1 first parent">
                                            <a href="women/styliest-bag.html">
                                                <span>Styliest Bag</span>
                                            </a>
                                            <ul class="level1">
                                                <li class="level2 nav-6-1-1 first">
                                                    <a href="women/styliest-bag/clutch-handbags.html">
                                                        <span>Clutch Handbags</span>
                                                    </a>
                                                </li><li class="level2 nav-6-1-2">
                                                    <a href="women/styliest-bag/diaper-bags.html">
                                                        <span>Diaper Bags</span>
                                                    </a>
                                                </li><li class="level2 nav-6-1-3">
                                                    <a href="women/styliest-bag/bags.html">
                                                        <span>Bags</span>
                                                    </a>
                                                </li><li class="level2 nav-6-1-4 last">
                                                    <a href="women/styliest-bag/hobo-handbags.html">
                                                        <span>Hobo Handbags</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li><li class="level1 item nav-6-2 parent">
                                            <a href="women/material-bag.html">
                                                <span>Material Bag</span>
                                            </a>
                                            <ul class="level1">
                                                <li class="level2 nav-6-2-5 first">
                                                    <a href="women/material-bag/beaded-handbags.html">
                                                        <span>Beaded Handbags</span>
                                                    </a>
                                                </li><li class="level2 nav-6-2-6">
                                                    <a href="women/material-bag/fabric-handbags.html">
                                                        <span>Fabric Handbags</span>
                                                    </a>
                                                </li><li class="level2 nav-6-2-7">
                                                    <a href="women/material-bag/handbags.html">
                                                        <span>Handbags</span>
                                                    </a>
                                                </li><li class="level2 nav-6-2-8 last">
                                                    <a href="women/material-bag/leather-handbags.html">
                                                        <span>Leather Handbags</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li><li class="level1 item nav-6-3 last parent">
                                            <a href="women/shoes.html">
                                                <span>Shoes</span>
                                            </a>
                                            <ul class="level1">
                                                <li class="level2 nav-6-3-9 first">
                                                    <a href="women/shoes/flat-shoes.html">
                                                        <span>Flat Shoes</span>
                                                    </a>
                                                </li><li class="level2 nav-6-3-10">
                                                    <a href="women/shoes/flat-sandals.html">
                                                        <span>Flat Sandals</span>
                                                    </a>
                                                </li><li class="level2 nav-6-3-11">
                                                    <a href="women/shoes/boots.html">
                                                        <span>Boots</span>
                                                    </a>
                                                </li><li class="level2 nav-6-3-12 last">
                                                    <a href="women/shoes/heels.html">
                                                        <span>Heels</span>
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <a href="footwear.html" class="level-top">
                                        <span>Footwear</span>
                                    </a>
                                </li><li class="level0 nav-9 level-top">
                                    <a href="jewellery.html" class="level-top">
                                        <span>Jewellery</span>
                                    </a>
                                    ...
                                    <div class="ulmenu-block ulmenu-block-center menu-items grid12-9 itemgrid itemgrid-3col">
                                        <ul class="level0">
                                            <li class="level1 groups item nav-1-1 first">
                                                ...
                                                <div class="ulmenu-block ulmenu-block-level1-top std">
                                                    <p><img src="<?php echo FRONT_ASSETS_PATH; ?>/wysiwyg/icotheme/puro/menu/menu1.jpg" alt="" /></p>
                                                </div>
                                                ...
                                                <div class="ulmenu-block ulmenu-block-level1-top std">
                                                    <img src="<?php echo FRONT_ASSETS_PATH; ?>/wysiwyg/icotheme/puro/menu/menu2.jpg" alt="" />
                                                </div>
                                                ...
                                                <div class="ulmenu-block ulmenu-block-level1-top std">
                                                    <img src="<?php echo FRONT_ASSETS_PATH; ?>/wysiwyg/icotheme/puro/menu/menu3.jpg" alt="" />
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="menu-static-blocks ulmenu-block ulmenu-block-right pull-right grid12-3">
                                        <img src="<?php echo FRONT_ASSETS_PATH; ?>/wysiwyg/icotheme/puro/menu/menu4.jpg" alt="" />
                                    </div>
                                </div>
                ...
                <div class="header-logo pull-left">
                    <a href="index.html" title="Puro Theme" class="logo">
